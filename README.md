...
You can specify [`HTML entities`](https://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references) for keys in a separate array. If an entity is not specified, 
